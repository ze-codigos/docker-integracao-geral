#!/bin/bash
# Sobe o stack local com credenciais homolog e registra o túnel WhatsApp.
#
# Pré-requisitos:
...
echo "[1/2] Subindo stack homolog${SERVICE:+ (serviço: $SERVICE)}..."
docker compose -f docker-compose.yml -f docker-compose.homolog.yaml up -d --build $SERVICE
